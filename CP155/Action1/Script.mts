...
Sub SeleccionarUbica()
		...
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"SeleccionamosUbicación.png", True
			imagenToWord "Seleccionamos Ubicación", RutaEvidencias() &"SeleccionamosUbicación.png"
